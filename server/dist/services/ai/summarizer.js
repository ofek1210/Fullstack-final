...
exports.buildLocalAnswer = buildLocalAnswer;
exports.buildFallbackAnswer = buildFallbackAnswer;
...
function buildLocalSummarySentences(query, keywords) {
...
function buildBulletInsights(titles, keywords) {
    const bullets = [];
...
function buildLocalAnswer(query, posts) {
...
function buildFallbackAnswer(query, wikipedia) {
